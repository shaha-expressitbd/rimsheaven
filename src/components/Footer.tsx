...
const socialLinks = [
  {
    icon: FaFacebookF,
    href: "https://www.facebook.com/rimsheavenbn",
    color: "#1877F2",
  },
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="space-y-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed max-w-md">
              Beyond trends, we create timeless beauty. Your style, your story,
              our passion.
            </p>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="text-sm">
                  Dress Express, green shoronika shopping mall, Dhaka,
                  Bangladesh
                </span>
              </motion.div>
            </div>
