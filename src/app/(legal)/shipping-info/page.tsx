...
export const metadata: Metadata = {
  title: "Shipping Information | rimsheaven",
  description:
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 md:py-16 py-4">
          <div className="text-center">
            ...
            <p className="text-sm md:text-xl text-red-100 max-w-3xl mx-auto leading-relaxed">
              Fast, reliable delivery across Bangladesh with transparent pricing
            ...
            <div className="p-8">
              ...
              <div className="mt-6 p-4 bg-red-600 text-white rounded-lg">
                <p className="text-sm font-medium">
                  📅 Business days exclude Fridays and public holidays in
                  Bangladesh
                </p>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-xl p-6">
                ...
                <div className="bg-red-600 text-white px-4 py-2 rounded-lg inline-block">
                  <span className="font-semibold">
                    🎉 Free shipping inside Dhaka for orders above ৳X
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden hover:shadow-2xl transition-all duration-300">
            ...
            <div className="p-8">
              <p className="text-gray-700 mb-6">
                We partner with reputable couriers to ensure reliable delivery
                across Bangladesh.
              </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden hover:shadow-2xl transition-all duration-300">
            ...
            <div className="p-8">
              <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-xl p-6">
                ...
                <p className="text-red-700 mb-4">
                  After dispatch, you will receive an email/SMS with your
                  tracking number.
                </p>
                <div className="bg-white rounded-lg p-4 border-2 border-red-200">
                  <p className="text-sm text-red-700">
                    💡 You can also view tracking information in your account
