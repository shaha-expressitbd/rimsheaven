      ...
      <main className="max-w-7xl mx-auto px-2 md:px-8 py-12">
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden hover:shadow-2xl transition-all duration-300">
            ...
            <div className="p-6">
              <p className="text-gray-700 leading-relaxed">
                By accessing or using Dress Express website you agree to be
                bound by these Terms & Conditions and all applicable laws. If
                you do not agree with any part of these terms, you must
          ...
          <section className="bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden hover:shadow-2xl transition-all duration-300">
            ...
            <div className="p-6">
              <p className="text-gray-700 leading-relaxed mb-4">
                You may not exploit the site for any unlawful purpose, transmit
                malicious code, or attempt to gain unauthorized access to data.
              </p>
          ...
          <section className="bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden hover:shadow-2xl transition-all duration-300">
            ...
            <div className="p-6">
              <p className="text-gray-700 leading-relaxed mb-4">
                All prices are listed in Bangladeshi Taka (BDT) unless otherwise
                stated. We reserve the right to refuse or cancel any order at
                our discretion.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-red-50 rounded-lg p-4">
                  ...
                  <p className="text-red-700 text-sm">
                    We accept various payment methods including mobile banking,
                ...
                <div className="bg-red-50 rounded-lg p-4">
                  ...
                  <p className="text-red-700 text-sm">
                    Orders are processed within 24 hours of confirmation and
            ...
            <div className="p-6">
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <span className="font-bold text-red-600">
                  Inside Dhaka — up to 5 business days
                </span>{" "}
                and{" "}
                <span className="font-bold text-red-600">
                  Outside Dhaka — up to 10 business days
                </span>
                . Full shipping details are outlined in our{" "}
                <a
                  href="/shipping-info"
                  className="text-red-600 hover:text-red-800 underline decoration-red-300 hover:decoration-red-600 transition-colors duration-300"
                >
                  Shipping Info
                </a>
                .
              ...
              <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-lg p-4">
                ...
                <p className="text-red-700 text-sm">
                  Delivery times may vary during peak seasons, holidays, or due
            ...
            <div className="p-6">
              ...
              <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                  <div className="text-center">
                    <div className="bg-red-600 text-white rounded-full w-6 h-6 flex items-center justify-center mx-auto mb-1 text-xs">
                      1
                    </div>
          ...
          <section className="bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden hover:shadow-2xl transition-all duration-300">
            ...
            <div className="p-6">
              <p className="text-gray-700 leading-relaxed mb-4">
                All content on this site is the property of Dress Express or its
                licensors and is protected under Bangladeshi copyright laws.
              </p>
              <div className="bg-red-50 rounded-lg p-4 border-l-4 border-red-500">
                <h3 className="font-semibold text-red-800 mb-2">
          ...
          <section className="bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden hover:shadow-2xl transition-all duration-300">
            ...
            <div className="p-6">
              ...
              <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-lg p-4">
                ...
                <p className="text-red-700 text-sm">
                  All legal matters will be handled according to Bangladeshi law
                  and regulations.
                </p>
              </div>
            </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-red-600 to-red-700 rounded-2xl shadow-xl p-8 text-white">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="mailto:support@rimsheaven.com"
