                        ...
                        <div className="lg:w-1/2 space-y-8">
                            ...
                            <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-[#FFD5DF]/50">
                                <p className="text-gray-700 text-justify leading-relaxed">
                                    rimsheaven -এ আপনাকে স্বাগতম! আমরা বাংলাদেশের একটি গর্বিত
                                    ...
                                    <span className="text-[#C43882] font-semibold">rimsheaven </span>{' '}
                            ...
                            <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-[#FFD5DF]/50">
                                ...
                                <p className="text-gray-700 text-justify leading-relaxed">
                                    rimsheaven -এ আপনি পাবেন এমন পোশাক যা আপনার আত্মবিশ্বাস বাড়াবে এবং
