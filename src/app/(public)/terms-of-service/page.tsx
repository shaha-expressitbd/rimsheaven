...
export const metadata: Metadata = {
  title: "Terms & Conditions | rimsheaven ",
      ...
      <main className="max-w-7xl mx-auto px-2 md:px-8 py-12">
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden hover:shadow-2xl transition-all duration-300">
            ...
            <div className="p-6">
              <p className="text-gray-700 leading-relaxed">
                By accessing or using rimsheaven  website you agree to be bound by these Terms & Conditions and all applicable laws. If you do not agree with any part of these terms, you must discontinue use of our website immediately.
              </p>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden hover:shadow-2xl transition-all duration-300">
            ...
            <div className="p-6">
              <p className="text-gray-700 leading-relaxed mb-4">
                All content on this site is the property of rimsheaven  or its licensors and is protected under Bangladeshi copyright laws.
              </p>
              <div className="bg-red-50 rounded-lg p-4 border-l-4 border-red-500">
        ...
        <div className="mt-12 bg-primary rounded-2xl shadow-xl p-8 text-white">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="mailto:support@rimsheavencom"
