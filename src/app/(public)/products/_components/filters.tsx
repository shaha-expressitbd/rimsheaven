...
export default function FilterContent({
  ...
  const FilterSection = ({
    ...
    return (
      <div
        className={`mb-4 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-secondary dark:bg-secondary hover:shadow-lg transition-all duration-300 ${isOpen ? "shadow-lg" : "shadow-sm"}`}
      >
        <button
        ...
        <aside className="mt-14 hidden md:block w-50">
          <div className="sticky top-24">
            ...
            <div className="rounded-2xl bg-secondary dark:bg-secondary border border-gray-200 dark:border-gray-700 shadow-xl">
              ...
              <div
                ref={scrollRef}
                className="p-6 space-y-4 max-h-[350px] md:max-h-[450px] lg:max-h-[600px] xl:max-h-[800px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-gray-100 dark:scrollbar-track-gray-800"
              >
                {/* Categories */}
                <FilterSection
                  title="Categories"
