# Migrate Tracking Code to rimsheaven

## Goal
Migrate the robust, production-ready GTM and Meta Pixel tracking implementation from `womensfashion_nextjs` to `rimsheaven _nextjs_main`. This includes the enhanced [gtm.ts](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/gtm.ts), [sourceTracking.ts](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/sourceTracking.ts), and refactoring usage of [trackPurchase](file:///c:/nextjs-e-com%20project/womensfashion_nextjs/src/utils/gtm.ts#686-718) to match the new signature.

## User Review Required
> [!IMPORTANT]
> This migration will replace [src/utils/gtm.ts](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/gtm.ts) and [src/utils/sourceTracking.ts](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/sourceTracking.ts) in `rimsheaven _nextjs_main` with the versions from `womensfashion_nextjs`.
>
...
- **Remove**:
    ...
    - Direct CAPI ([sendToCapi](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/gtm.ts#451-469)) calls.
    - Code related to [metaPixel.ts](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/metaPixel.ts) or `metaCapi.ts`.
...
- **Functions to Migrate/Verify**:
    ...
    - [ ] [trackViewRelatedItemList](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/gtm.ts#940-955)
    - [ ] [trackAddToCart](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/gtm.ts#696-726)
    - [ ] [trackRemoveFromCart](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/gtm.ts#727-748)
    - [ ] [trackUpdateItemQuantity](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/gtm.ts#916-939)
    - [ ] [trackAddToWishlist](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/gtm.ts#886-915)
    - [ ] [trackBeginCheckout](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/gtm.ts#749-785)
...
- Import [detectAndStoreCustomerSource](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/sourceTracking.ts#242-284) and helper functions from `womensfashion_nextjs` to ensure consistent source detection (TikTok, UTM, etc.).
...
- **Remove**: Any imports or usages of [metaPixel.ts](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/metaPixel.ts) or `FaceBookPixel` components if they exist.

#### [VERIFY] src/app/layout.tsx
- Ensure [detectAndStoreCustomerSource()](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/sourceTracking.ts#242-284) and [storeUtmParams()](file:///c:/main-e-com-nextjs/rimsheaven _nextjs_main/src/utils/gtm.ts#1153-1181) are called (already present, will verify).
